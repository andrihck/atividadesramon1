                ...
                <CameraView style={styles.camera} facing={ladoCamera} ref={cameraRef}>
                    <View style={styles.botaosalvar}>
                        <Pressable onPress={tirarFoto}>
                            <Image source={require('../camera/img/foto.png')} style={styles.iconfoto} />
                        </Pressable>
                        <Pressable onPress={inverterLadoCamera}>
                            <Image source={require('../camera/img/reverse.png')} style={styles.iconreverse} />
                        </Pressable>
                        <Pressable onPress={() => setScanning(true)}>
                          <Image source={require('../camera/img/qrCode.png')} style={styles.iconqrCode} />
                        </Pressable>
                    </View>
                </CameraView>
            )}
